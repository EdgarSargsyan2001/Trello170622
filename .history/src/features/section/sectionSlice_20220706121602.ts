...
export const sectionSlice = createSlice({
  ...
  reducers: {
    ...
    editTask: (state, action) => {
      ...
      const {idTask,idSec ,nowPlaceSec,title,desc,color1,color2} = action.payload
      
      return dragDropFC(state, idTask, idSec, nowPlaceSec);
      console.log(idTask,idSec ,nowPlaceSec,title,desc,color1,color2)
      // taskId,secId ,nowPlaceSec,title,desc,color1,color2
